...
const productCard = (product) => ({ id: product._id, categoryId: product.category?._id || product.category, title: product.name, description: product.description, image: product.image || AssetsData.ChickenCheeseOmellete, isAvailable: product.isAvailable !== false, options: product.options?.length ? product.options : [{ name: "Regular", actualPrice: product.price }] });
